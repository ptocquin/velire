 ...
 */
final class Version20181020103432 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE program (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, label VARCHAR(255) DEFAULT NULL, description CLOB DEFAULT NULL)');
