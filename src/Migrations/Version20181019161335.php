 ...
 */
final class Version20181019161335 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ingredient (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, led_id INTEGER NOT NULL, recipe_id INTEGER DEFAULT NULL, level INTEGER NOT NULL)');
        ...
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, label VARCHAR(255) DEFAULT NULL, description CLOB DEFAULT NULL)');
