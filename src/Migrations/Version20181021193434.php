 ...
 */
final class Version20181021193434 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__step AS SELECT id, program_id, type, rank, value FROM step');
        $this->addSql('DROP TABLE step');
        $this->addSql('CREATE TABLE step (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, program_id INTEGER DEFAULT NULL, type VARCHAR(255) NOT NULL COLLATE BINARY, rank INTEGER NOT NULL, value VARCHAR(255) NOT NULL, CONSTRAINT FK_43B9FE3C3EB8070A FOREIGN KEY (program_id) REFERENCES program (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO step (id, program_id, type, rank, value) SELECT id, program_id, type, rank, value FROM __temp__step');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__step AS SELECT id, program_id, type, rank, value FROM step');
        $this->addSql('DROP TABLE step');
        $this->addSql('CREATE TABLE step (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, program_id INTEGER DEFAULT NULL, type VARCHAR(255) NOT NULL, rank INTEGER NOT NULL, value INTEGER NOT NULL)');
        $this->addSql('INSERT INTO step (id, program_id, type, rank, value) SELECT id, program_id, type, rank, value FROM __temp__step');
        $this->addSql('DROP TABLE __temp__step');
        $this->addSql('CREATE INDEX IDX_43B9FE3C3EB8070A ON step (program_id)');
    }
