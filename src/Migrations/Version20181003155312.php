 ...
 */
final class Version20181003155312 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cluster (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, label INTEGER NOT NULL, description VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__luminaire AS SELECT id, groupe_id, serial, address FROM luminaire');
        ...
        $this->addSql('INSERT INTO luminaire (id, cluster_id, serial, address) SELECT id, groupe_id, serial, address FROM __temp__luminaire');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "group" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, label INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        ...
        $this->addSql('DROP TABLE luminaire');
        $this->addSql('CREATE TABLE luminaire (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, groupe_id INTEGER DEFAULT NULL, serial VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_BF3BAD1BC36A3328 FOREIGN KEY (groupe_id) REFERENCES cluster (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO luminaire (id, groupe_id, serial, address) SELECT id, cluster_id, serial, address FROM __temp__luminaire');
        $this->addSql('DROP TABLE __temp__luminaire');
